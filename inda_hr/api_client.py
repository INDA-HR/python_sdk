...
from inda_hr.exceptions import ApiTypeError, ApiValueError, ApiException
from inda_hr.model_utils import (ModelNormal, ModelSimple, ModelComposed,
                                 check_allowed_values, check_validations, date,
                                 datetime, deserialize_file, file_type,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ApplicationManagementApi()
        api_instance.add_application_post  # this is an instance of the class Endpoint
        api_instance.add_application_post()  # this invokes api_instance.add_application_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_application_post.callable or self.callable in this class
