...
SchemaFor200ResponseBodyApplicationJson = DeleteApplicationResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_application_delete_oapg(
        self,
...
class DeleteApplicationDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_application_delete(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_application_delete(
        ...
        return self._delete_application_delete_oapg(
