...
# body param
SchemaForRequestBodyApplicationJson = PatchApplicationRequest


request_body_patch_application_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PatchApplicationResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_application_patch_oapg(
        self,
    ...
    def _patch_application_patch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_application_request.serialize(body, content_type)
...
class PatchApplicationPatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_application_patch(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_application_patch(
        ...
        return self._patch_application_patch_oapg(
            body=body,
