...
SchemaFor200ResponseBodyApplicationJson = ClassificationMappingIstatResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _mapping_istat_cp2011_get_oapg(
        self,
...
class MappingIstatCp2011Get(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def mapping_istat_cp2011_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def mapping_istat_cp2011_get(
        ...
        return self._mapping_istat_cp2011_get_oapg(
