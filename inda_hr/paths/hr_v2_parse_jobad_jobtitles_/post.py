...
SchemaFor200ResponseBodyApplicationJson = JobAdJobTitlesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _extract_jobtitles_from_jobad_post_oapg(
        self,
...
class ExtractJobtitlesFromJobadPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def extract_jobtitles_from_jobad_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def extract_jobtitles_from_jobad_post(
        ...
        return self._extract_jobtitles_from_jobad_post_oapg(
            body=body,
