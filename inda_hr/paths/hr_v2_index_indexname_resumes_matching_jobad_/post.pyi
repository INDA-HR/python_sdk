...
# body param
SchemaForRequestBodyApplicationJson = ResumeMatchingQuery


request_body_resume_matching_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _match_resumes_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_resume_matching_query.serialize(body, content_type)
...
class MatchResumesPost(BaseApi):
    ...
    def match_resumes_post(
        ...
        return self._match_resumes_post_oapg(
            body=body,
