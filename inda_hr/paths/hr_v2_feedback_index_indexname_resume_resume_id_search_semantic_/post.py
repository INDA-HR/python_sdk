...
# body param
SchemaForRequestBodyApplicationJson = SemanticFeedbackRequest


request_body_semantic_feedback_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FeedbackResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _semantic_search_feedback_post_oapg(
        self,
    ...
    def _semantic_search_feedback_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_semantic_feedback_request.serialize(body, content_type)
...
class SemanticSearchFeedbackPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def semantic_search_feedback_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def semantic_search_feedback_post(
        ...
        return self._semantic_search_feedback_post_oapg(
            body=body,
