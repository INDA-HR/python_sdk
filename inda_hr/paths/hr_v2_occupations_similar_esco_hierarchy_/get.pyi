...
SchemaFor200ResponseBodyApplicationJson = MostSimilarJobtitleResponseCategorized
...
class BaseApi(api_client.Api):
    @typing.overload
    def _esco_occupations_hierarchy_get_oapg(
        self,
...
class EscoOccupationsHierarchyGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def esco_occupations_hierarchy_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def esco_occupations_hierarchy_get(
        ...
        return self._esco_occupations_hierarchy_get_oapg(
