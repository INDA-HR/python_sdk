...
# body param
SchemaForRequestBodyApplicationJson = BaseJobadMatchingEvidenceQuery


request_body_base_jobad_matching_evidence_query = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MatchJobAdEvidenceResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _match_jobads_evidence_from_indexed_resume_post_oapg(
        self,
    ...
    def _match_jobads_evidence_from_indexed_resume_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_base_jobad_matching_evidence_query.serialize(body, content_type)
...
class MatchJobadsEvidenceFromIndexedResumePost(BaseApi):
    ...
    def match_jobads_evidence_from_indexed_resume_post(
        ...
        return self._match_jobads_evidence_from_indexed_resume_post_oapg(
            body=body,
