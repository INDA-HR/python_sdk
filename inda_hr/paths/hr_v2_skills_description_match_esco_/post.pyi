...
SchemaFor200ResponseBodyApplicationJson = EscoSkillResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _from_description_to_esco_skills_post_oapg(
        self,
...
class FromDescriptionToEscoSkillsPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def from_description_to_esco_skills_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def from_description_to_esco_skills_post(
        ...
        return self._from_description_to_esco_skills_post_oapg(
            body=body,
