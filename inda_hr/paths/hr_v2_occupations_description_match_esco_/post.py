...
# body param
SchemaForRequestBodyApplicationJson = DescriptionInput


request_body_description_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EscoJobtitleResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _from_description_to_esco_occupations_post_oapg(
        self,
    ...
    def _from_description_to_esco_occupations_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_description_input.serialize(body, content_type)
...
class FromDescriptionToEscoOccupationsPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def from_description_to_esco_occupations_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def from_description_to_esco_occupations_post(
        ...
        return self._from_description_to_esco_occupations_post_oapg(
            body=body,
