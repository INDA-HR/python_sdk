...
# body param
SchemaForRequestBodyApplicationJson = LoginData


request_body_login_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _log_in_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_login_data.serialize(body, content_type)
