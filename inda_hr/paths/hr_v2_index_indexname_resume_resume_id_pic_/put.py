...
# body param
SchemaForRequestBodyApplicationJson = UpdatePicRequest


request_body_update_pic_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_pic_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_pic_request.serialize(body, content_type)
...
class UpdatePicPut(BaseApi):
    ...
    def update_pic_put(
        ...
        return self._update_pic_put_oapg(
            body=body,
