...
SchemaFor200ResponseBodyApplicationJson = CompanyAutocompleteResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _company_autocomplete_get_oapg(
        self,
...
class CompanyAutocompleteGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def company_autocomplete_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def company_autocomplete_get(
        ...
        return self._company_autocomplete_get_oapg(
