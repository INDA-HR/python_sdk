...
# body param
SchemaForRequestBodyApplicationJson = DocsImportItemRequest


request_body_docs_import_item_request = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = ImportResponse
...
class BaseApi(api_client.Api):
    ...
    def _aws_import_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_docs_import_item_request.serialize(body, content_type)
...
class AwsImportPost(BaseApi):
    ...
    def aws_import_post(
        ...
        return self._aws_import_post_oapg(
            body=body,
