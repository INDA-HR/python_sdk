...
# body param
SchemaForRequestBodyApplicationJson = BaseResumeMatchingEvidenceQuery


request_body_base_resume_matching_evidence_query = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MatchResumeEvidenceResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _match_resumes_evidence_from_indexed_jobad_post_oapg(
        self,
    ...
    def _match_resumes_evidence_from_indexed_jobad_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_base_resume_matching_evidence_query.serialize(body, content_type)
...
class MatchResumesEvidenceFromIndexedJobadPost(BaseApi):
    ...
    def match_resumes_evidence_from_indexed_jobad_post(
        ...
        return self._match_resumes_evidence_from_indexed_jobad_post_oapg(
            body=body,
