...
# Query params
ImportIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'import_id': typing.Union[ImportIdSchema, str, ],
        'resume_id': typing.Union[ResumeIdSchema, str, ],
        'jobad_id': typing.Union[JobadIdSchema, str, ],
        'doc_type': typing.Union[DocTypeSchema, str, ],
    },
    total=False
)
...
request_query_import_id = api_client.QueryParameter(
    name="import_id",
...
request_query_jobad_id = api_client.QueryParameter(
    name="jobad_id",
    style=api_client.ParameterStyle.FORM,
    schema=JobadIdSchema,
    explode=True,
)
request_query_doc_type = api_client.QueryParameter(
    name="doc_type",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = IndexedDocumentFailuresResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_failures_get_oapg(
        ...
        for parameter in (
            request_query_import_id,
            request_query_resume_id,
            request_query_jobad_id,
            request_query_doc_type,
        ):
...
class GetFailuresGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_failures_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_failures_get(
        ...
        return self._get_failures_get_oapg(
