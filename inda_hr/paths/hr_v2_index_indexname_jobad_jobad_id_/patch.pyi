...
# body param
SchemaForRequestBodyApplicationJson = PatchJobAdRequest


request_body_patch_job_ad_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PatchJobAdResponse
...
class BaseApi(api_client.Api):
    ...
    def _patch_jobad_patch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_job_ad_request.serialize(body, content_type)
...
class PatchJobadPatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_jobad_patch(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def patch_jobad_patch(
        ...
        return self._patch_jobad_patch_oapg(
            body=body,
