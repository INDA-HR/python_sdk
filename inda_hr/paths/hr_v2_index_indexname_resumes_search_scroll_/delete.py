...
SchemaFor200ResponseBodyApplicationJson = CacheDeletion
...
class BaseApi(api_client.Api):
    @typing.overload
    def _clear_search_results_delete_oapg(
        self,
...
class ClearSearchResultsDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def clear_search_results_delete(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def clear_search_results_delete(
        ...
        return self._clear_search_results_delete_oapg(
