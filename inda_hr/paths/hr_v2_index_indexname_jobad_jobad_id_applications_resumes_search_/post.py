...
# body param
SchemaForRequestBodyApplicationJson = CandidateSearchQuery


request_body_candidate_search_query = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FoundCandidatesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_applicants_post_oapg(
        self,
    ...
    def _search_applicants_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_candidate_search_query.serialize(body, content_type)
...
class SearchApplicantsPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def search_applicants_post(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def search_applicants_post(
        ...
        return self._search_applicants_post_oapg(
            body=body,
