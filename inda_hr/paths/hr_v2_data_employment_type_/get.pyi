...
SchemaFor200ResponseBodyApplicationJson = GetExtendedStandardDataResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_employment_type_get_oapg(
        self,
...
class GetEmploymentTypeGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_employment_type_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_employment_type_get(
        ...
        return self._get_employment_type_get_oapg(
