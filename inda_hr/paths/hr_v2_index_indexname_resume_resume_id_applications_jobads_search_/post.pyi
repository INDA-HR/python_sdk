...
# body param
SchemaForRequestBodyApplicationJson = JobAdSearchQuery


request_body_job_ad_search_query = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_applications_post_oapg(
        self,
    ...
    def _search_applications_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_job_ad_search_query.serialize(body, content_type)
...
class SearchApplicationsPost(BaseApi):
    ...
    def search_applications_post(
        ...
        return self._search_applications_post_oapg(
            body=body,
