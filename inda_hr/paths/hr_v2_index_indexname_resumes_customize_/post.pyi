...
# body param
SchemaForRequestBodyApplicationJson = CustomFields


request_body_custom_fields = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CustomizedFields
...
class BaseApi(api_client.Api):
    @typing.overload
    def _customize_resumes_post_oapg(
        self,
    ...
    def _customize_resumes_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_custom_fields.serialize(body, content_type)
...
class CustomizeResumesPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def customize_resumes_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def customize_resumes_post(
        ...
        return self._customize_resumes_post_oapg(
            body=body,
