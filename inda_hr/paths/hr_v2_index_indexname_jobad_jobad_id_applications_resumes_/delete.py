...
SchemaFor200ResponseBodyApplicationJson = DeleteCandidatesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_applicants_delete_oapg(
        self,
...
class DeleteApplicantsDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_applicants_delete(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_applicants_delete(
        ...
        return self._delete_applicants_delete_oapg(
