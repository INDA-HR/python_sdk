...
class SrcLangSchema(
    ...
    def PT(cls):
        return cls("pt")
DstLangSchema = schemas.StrSchema
GraphicsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'graphics': typing.Union[GraphicsSchema, bool, ],
    },
    total=False
)
...
request_query_graphics = api_client.QueryParameter(
    name="graphics",
    style=api_client.ParameterStyle.FORM,
...
# body param
SchemaForRequestBodyApplicationJson = BaseFile


request_body_base_file = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ExtractionItem
...
class BaseApi(api_client.Api):
    ...
    def _parse_resume_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_base_file.serialize(body, content_type)
...
class ParseResumePost(BaseApi):
    ...
    def parse_resume_post(
        ...
        return self._parse_resume_post_oapg(
            body=body,
