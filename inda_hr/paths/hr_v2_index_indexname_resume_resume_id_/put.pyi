...
# body param
SchemaForRequestBodyApplicationJson = UpdateItemRequest


request_body_update_item_request = api_client.RequestBody(
    content={
...
SchemaFor409ResponseBodyApplicationJson = BaseModelsErrorModel
...
SchemaFor422ResponseBodyApplicationJson = BaseModelsErrorModel
...
class BaseApi(api_client.Api):
    ...
    def _update_resume_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_item_request.serialize(body, content_type)
...
class UpdateResumePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_resume_put(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_resume_put(
        ...
        return self._update_resume_put_oapg(
            body=body,
