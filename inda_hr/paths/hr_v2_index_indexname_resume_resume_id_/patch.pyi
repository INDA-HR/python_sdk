...
# body param
SchemaForRequestBodyApplicationJson = PatchItemRequest


request_body_patch_item_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PatchItemResponse
...
class BaseApi(api_client.Api):
    ...
    def _patch_resume_patch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_item_request.serialize(body, content_type)
...
class PatchResumePatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_resume_patch(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def patch_resume_patch(
        ...
        return self._patch_resume_patch_oapg(
            body=body,
