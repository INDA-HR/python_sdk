...
SchemaFor200ResponseBodyApplicationJson = ApplicationResponsesStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _application_status_get_oapg(
        self,
...
class ApplicationStatusGet(BaseApi):
    ...
    def application_status_get(
        ...
        return self._application_status_get_oapg(
