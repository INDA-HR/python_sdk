...
# body param
SchemaForRequestBodyApplicationJson = JobAdRequest


request_body_job_ad_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = JobAdIDResponse
...
SchemaFor200ResponseBodyApplicationJson = JobAdIDResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_jobad_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_job_ad_request.serialize(body, content_type)
...
class AddJobadPost(BaseApi):
    ...
    def add_jobad_post(
        ...
        return self._add_jobad_post_oapg(
            body=body,
