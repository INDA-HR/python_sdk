...
# body param
SchemaForRequestBodyApplicationJson = EvidenceRequest


request_body_evidence_request = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SearchEvidence']:
            return SearchEvidence

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SearchEvidence'], typing.List['SearchEvidence']],
    ...
    def __getitem__(self, i: int) -> 'SearchEvidence':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_resumes_evidence_post_oapg(
        self,
    ...
    def _search_resumes_evidence_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_evidence_request.serialize(body, content_type)
...
class SearchResumesEvidencePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def search_resumes_evidence_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def search_resumes_evidence_post(
        ...
        return self._search_resumes_evidence_post_oapg(
            body=body,
