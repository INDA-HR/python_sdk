...
# body param
SchemaForRequestBodyApplicationJson = SearchCreditsRequest


request_body_search_credits_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = IndexCreditsInfo
...
class BaseApi(api_client.Api):
    ...
    def _search_credits_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_search_credits_request.serialize(body, content_type)
...
class SearchCreditsPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def search_credits_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def search_credits_post(
        ...
        return self._search_credits_post_oapg(
            body=body,
