...
SchemaFor200ResponseBodyApplicationJson = DeleteApplicationsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_applications_delete_oapg(
        self,
...
class DeleteApplicationsDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_applications_delete(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_applications_delete(
        ...
        return self._delete_applications_delete_oapg(
