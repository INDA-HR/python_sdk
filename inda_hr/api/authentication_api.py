...
class AuthenticationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.log_in_post_endpoint = _Endpoint(settings={
            'response_type': (TokenResponse, ),
            'auth': [],
            'endpoint_path': '/hr/v2/auth/login/',
            'operation_id': 'log_in_post',
            'http_method': 'POST',
            'servers': None,
        },
                                              params_map={
    ...
    def log_in_post(self, login_data, **kwargs):
        """Log In  # noqa: E501

        This method allows a user to log into the service and receive access credentials in the form of a bearer token. The token expires after  *ExpiresIn* seconds, as detailed in the response.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.log_in_post(login_data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['login_data'] = \
            login_data
        return self.log_in_post_endpoint.call_with_http_info(**kwargs)
