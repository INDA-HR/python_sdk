...
class OccupationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.similar_jobtitles_get_endpoint = _Endpoint(
            settings={
                'response_type': (SimilarEntitiesResponse, ),
                'auth': ['APIKey'],
                'endpoint_path': '/hr/v2/occupations/similar/semantic/',
                'operation_id': 'similar_jobtitles_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def similar_jobtitles_get(self, query, **kwargs):
        ...
        kwargs['query'] = \
            query
        return self.similar_jobtitles_get_endpoint.call_with_http_info(
            **kwargs)
