...
class ClearCacheApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.clear_search_results_delete_endpoint = _Endpoint(
            settings={
                'response_type': (CacheDeletion, ),
                'auth': ['APIKey'],
                'endpoint_path':
                '/hr/v2/index/{indexname}/resumes/search/scroll/',
                'operation_id': 'clear_search_results_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def clear_search_results_delete(self, indexname, search_id, **kwargs):
        ...
        kwargs['search_id'] = \
            search_id
        return self.clear_search_results_delete_endpoint.call_with_http_info(
            **kwargs)
