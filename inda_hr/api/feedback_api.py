...
class FeedbackApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.info_extraction_feedback_post_endpoint = _Endpoint(
            settings={
                'response_type': (FeedbackResponse, ),
                'auth': ['APIKey'],
                'endpoint_path':
                '/hr/v2/feedback/index/{indexname}/resume/{resume_id}/parse/data/',
                'operation_id': 'info_extraction_feedback_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.semantic_search_feedback_post_endpoint = _Endpoint(
            settings={
                'response_type': (FeedbackResponse, ),
                'auth': ['APIKey'],
                'endpoint_path':
                '/hr/v2/feedback/index/{indexname}/resume/{resume_id}/search/semantic/',
                'operation_id': 'semantic_search_feedback_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'indexname': 'path',
                    'resume_id': 'path',
                    'semantic_feedback_request': 'body',
                },
                'collection_format_map': {}
            },
            headers_map={
    ...
    def semantic_search_feedback_post(self, indexname, resume_id,
        ...
        kwargs['resume_id'] = \
            resume_id
        kwargs['semantic_feedback_request'] = \
            semantic_feedback_request
        return self.semantic_search_feedback_post_endpoint.call_with_http_info(
            **kwargs)
