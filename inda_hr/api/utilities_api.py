...
class UtilitiesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.clear_index_cache_delete_endpoint = _Endpoint(
            settings={
                'response_type': (IndexCacheDeletionResponse, ),
                'auth': ['APIKey'],
                'endpoint_path': '/hr/v2/index/{indexname}/cache/',
                'operation_id': 'clear_index_cache_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'clean_fielddata': 'clean_fielddata',
        ...
        self.health_status_get_endpoint = _Endpoint(
            settings={
                'response_type': (Check, ),
                'auth': ['APIKey'],
                'endpoint_path': '/hr/v2/',
    ...
    def clear_index_cache_delete(self, indexname, **kwargs):
        ...
        kwargs['indexname'] = \
            indexname
        return self.clear_index_cache_delete_endpoint.call_with_http_info(
            **kwargs)

    def health_status_get(self, **kwargs):
        ...
        kwargs['_content_type'] = kwargs.get('_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.health_status_get_endpoint.call_with_http_info(**kwargs)
