...
class ResumeManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_resume_post_endpoint = _Endpoint(settings={
            'response_type': (ItemIdResponse, ),
            'auth': ['APIKey'],
            'endpoint_path':
            '/hr/v2/index/{indexname}/resume/',
            'operation_id':
            'add_resume_post',
            'http_method':
            'POST',
