...
class FailuresApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_failures_get_endpoint = _Endpoint(
            settings={
                'response_type': (IndexedDocumentFailuresResponse, ),
                'auth': ['APIKey'],
                'endpoint_path': '/hr/v2/index/{indexname}/failures/',
                'operation_id': 'get_failures_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_failures_get(self, indexname, **kwargs):
        """Get Failures  # noqa: E501
        ...
        >>> thread = api.get_failures_get(indexname, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['indexname'] = \
            indexname
        return self.get_failures_get_endpoint.call_with_http_info(**kwargs)
