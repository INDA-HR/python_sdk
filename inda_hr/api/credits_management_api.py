...
class CreditsManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.search_credits_post_endpoint = _Endpoint(
            settings={
                'response_type': (IndexCreditsInfo, ),
                'auth': ['APIKey'],
                'endpoint_path': '/hr/v2/index/{indexname}/credits/',
                'operation_id': 'search_credits_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def search_credits_post(self, indexname, search_credits_request, **kwargs):
        ...
        kwargs['indexname'] = \
            indexname
        kwargs['search_credits_request'] = \
            search_credits_request
        return self.search_credits_post_endpoint.call_with_http_info(**kwargs)
