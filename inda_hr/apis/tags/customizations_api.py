...
from inda_hr.paths.hr_v2_index_indexname_resumes_customize_.post import CustomizeResumesPost
from inda_hr.paths.hr_v2_index_indexname_resumes_mapping_.get import GetResumeCustomizationsGet
