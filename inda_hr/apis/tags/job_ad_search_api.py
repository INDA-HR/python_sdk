...
from inda_hr.paths.hr_v2_index_indexname_jobads_search_full_text_.post import FullTextSearchOnJobadsPost
from inda_hr.paths.hr_v2_index_indexname_resume_resume_id_applications_jobads_search_.post import SearchApplicationsPost
