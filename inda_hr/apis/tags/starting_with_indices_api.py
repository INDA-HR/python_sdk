...
from inda_hr.paths.hr_v2_index_indexname_resumes_latest_.get import MostRecentResumesGet
from inda_hr.paths.hr_v2_index_indexname_stats_.get import StatsIndexGet
