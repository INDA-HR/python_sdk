...
from inda_hr.paths.hr_v2_index_indexname_resumes_import_aws_.post import AwsImportPost
from inda_hr.paths.hr_v2_index_indexname_resumes_import_aws_status_.get import ImportStatusGet


class ResumeImportApi(
        AwsImportPost,
        ImportStatusGet,
):
