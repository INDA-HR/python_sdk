...
class RequiredAndPreferredListMatchJobAdEvidenceSkill(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'required': ([MatchJobAdEvidenceSkill], ),  # noqa: E501
            'preferred': ([MatchJobAdEvidenceSkill], ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, required, preferred, *args,
                           **kwargs):  # noqa: E501
        """RequiredAndPreferredListMatchJobAdEvidenceSkill - a model defined in OpenAPI

        Args:
            required ([MatchJobAdEvidenceSkill]):
            preferred ([MatchJobAdEvidenceSkill]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, required, preferred, *args, **kwargs):  # noqa: E501
        """RequiredAndPreferredListMatchJobAdEvidenceSkill - a model defined in OpenAPI
