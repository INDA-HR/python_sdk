...
class TokenResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Token", "TokenType", "ExpiresIn", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Token", "TokenType", "ExpiresIn", ], str]):
