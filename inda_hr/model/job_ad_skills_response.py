...
def lazy_import():
    ...
    globals()['SlimJobAdSkill'] = SlimJobAdSkill


class JobAdSkillsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'hits': (int, ),  # noqa: E501
            'skills': ([SlimJobAdSkill], ),  # noqa: E501
    ...
    def _from_openapi_data(cls, hits, skills, *args, **kwargs):  # noqa: E501
        """JobAdSkillsResponse - a model defined in OpenAPI

        Args:
            hits (int):
            skills ([SlimJobAdSkill]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, hits, skills, *args, **kwargs):  # noqa: E501
        """JobAdSkillsResponse - a model defined in OpenAPI
