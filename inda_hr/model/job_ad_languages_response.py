...
def lazy_import():
    ...
    globals()['SlimJobAdLanguage'] = SlimJobAdLanguage


class JobAdLanguagesResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'hits': (int, ),  # noqa: E501
            'languages': ([SlimJobAdLanguage], ),  # noqa: E501
    ...
    def _from_openapi_data(cls, hits, languages, *args,
                           **kwargs):  # noqa: E501
        """JobAdLanguagesResponse - a model defined in OpenAPI

        Args:
            hits (int):
            languages ([SlimJobAdLanguage]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, hits, languages, *args, **kwargs):  # noqa: E501
        """JobAdLanguagesResponse - a model defined in OpenAPI
