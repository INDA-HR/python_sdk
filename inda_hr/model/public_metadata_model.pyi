...
class PublicMetadataModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["LastModified"], typing_extensions.Literal["CreationDate"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["LastModified"], typing_extensions.Literal["CreationDate"], ]):
