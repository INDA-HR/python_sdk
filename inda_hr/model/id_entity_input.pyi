...
class IdEntityInput(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Entity() -> typing.Type['EntityInput']:
                return EntityInput
            __annotations__ = {
                "EntityID": EntityID,
                "Entity": Entity,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Entity"]) -> 'EntityInput': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EntityID"], typing_extensions.Literal["Entity"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Entity"]) -> 'EntityInput': ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EntityID"], typing_extensions.Literal["Entity"], ]):
