...
class OptionalJobAdLanguageDetails(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Code"]) -> 'JobAdLanguageCode': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Code"]) -> typing.Union['JobAdLanguageCode', schemas.Unset]: ...
