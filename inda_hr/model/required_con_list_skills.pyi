...
class RequiredConListSkills(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Required"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Required"], ]):
