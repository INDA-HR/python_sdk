...
class QueryTerm(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Term"], typing_extensions.Literal["Language"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Term"], typing_extensions.Literal["Language"], ]):
