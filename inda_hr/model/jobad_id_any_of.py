...
class JobadIdAnyOf(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """JobadIdAnyOf - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "auto", must be one of ["auto", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "auto", must be one of ["auto", ]  # noqa: E501
