...
class SemanticCommonSimpleTerm(ModelNormal):
    ...
    def _from_openapi_data(cls, term, *args, **kwargs):  # noqa: E501
        """SemanticCommonSimpleTerm - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            exclude (bool): Optional. Exclude documents that match this term from the result, which is equivalent to the boolean NOT operator.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
