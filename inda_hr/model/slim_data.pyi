...
class SlimData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["JobDescription"], typing_extensions.Literal["JobTitle"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["JobDescription"], typing_extensions.Literal["JobTitle"], ]):
