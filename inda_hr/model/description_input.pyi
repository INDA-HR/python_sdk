...
class DescriptionInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Description"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Description"], ]):
