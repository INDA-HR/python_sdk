...
class UniversityPublicMetadata(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["Exists"]
    ) -> MetaOapg.properties.Exists:
        ...

    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["LastModified"],
                                 typing_extensions.Literal["CreationDate"],
                                 typing_extensions.Literal["Exists"], ]):
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["Exists"]
    ) -> typing.Union[MetaOapg.properties.Exists, schemas.Unset]:
        ...
