...
class UniversityPublicMetadata(ModelNormal):
    ...
    def _from_openapi_data(cls, creation_date, last_modified, *args,
                           **kwargs):  # noqa: E501
        """UniversityPublicMetadata - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            exists (bool): Whether the University still exists today or not.. [optional] if omitted the server will use the default value of True  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, creation_date, last_modified, *args,
                 **kwargs):  # noqa: E501
        """UniversityPublicMetadata - a model defined in OpenAPI
