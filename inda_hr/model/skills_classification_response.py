...
def lazy_import():
    ...
    globals()['SkillsResponsesSkill'] = SkillsResponsesSkill


class SkillsClassificationResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'skills': ([SkillsResponsesSkill], ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, skills, *args, **kwargs):  # noqa: E501
        """SkillsClassificationResponse - a model defined in OpenAPI

        Args:
            skills ([SkillsResponsesSkill]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, skills, *args, **kwargs):  # noqa: E501
        """SkillsClassificationResponse - a model defined in OpenAPI
