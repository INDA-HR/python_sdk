...
def lazy_import():
    ...
    globals()['QueryTerm'] = QueryTerm


class SimilarWordsQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'query_terms': ([QueryTerm], ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, query_terms, *args, **kwargs):  # noqa: E501
        """SimilarWordsQuery - a model defined in OpenAPI

        Args:
            query_terms ([QueryTerm]): List of terms with which the query is performed.Each term is composed by a *term* and its *language*.
