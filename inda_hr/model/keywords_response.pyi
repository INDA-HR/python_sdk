...
class KeywordsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Out(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['KeywordsOut'], typing.List['KeywordsOut']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Errors"], typing_extensions.Literal["Out"], typing_extensions.Literal["Hits"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Errors"], typing_extensions.Literal["Out"], typing_extensions.Literal["Hits"], ]):
