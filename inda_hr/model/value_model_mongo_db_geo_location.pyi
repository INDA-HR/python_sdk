...
class ValueModelMongoDBGeoLocation(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Value"]) -> 'MongoDBGeoLocation': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Value"]) -> 'MongoDBGeoLocation': ...
