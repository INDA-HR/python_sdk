...
class IdEntityErrors(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EntityID"], typing_extensions.Literal["Error"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EntityID"], typing_extensions.Literal["Error"], ]):
