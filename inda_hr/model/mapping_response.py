...
class MappingResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, indexname, custom, *args,
                           **kwargs):  # noqa: E501
        """MappingResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            doc_type (str): [optional]  # noqa: E501
            custom_fields ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Each item of its key-value pairs is the dot-notation path of a custom field and the relative type.. [optional]  # noqa: E501
            multiplier (float): How much the added custom fields will impact on pricing.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, indexname, custom, *args, **kwargs):  # noqa: E501
        """MappingResponse - a model defined in OpenAPI
