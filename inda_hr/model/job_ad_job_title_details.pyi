...
class JobAdJobTitleDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Weight"], typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["IsValidated"], typing_extensions.Literal["EntityType"], typing_extensions.Literal["ProficiencyLevel"], typing_extensions.Literal["Category"], typing_extensions.Literal["Code"], ]):
