...
class MultiEntityMapping(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Entities(schemas.ListSchema):

                class MetaOapg:

                    @staticmethod
                    def items() -> typing.Type['IdEntityMapping']:
                        return IdEntityMapping

                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['IdEntityMapping'],
                                       typing.List['IdEntityMapping']],
                ...
                def __getitem__(self, i: int) -> 'IdEntityMapping':
            ...
            class Errors(schemas.ListSchema):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IdEntityErrors']:
                        return IdEntityErrors

                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['IdEntityErrors'],
                                       typing.List['IdEntityErrors']],
                    _configuration: typing.Optional[
                        schemas.Configuration] = None,
                ) -> 'Errors':
                    return super().__new__(
                ...
                def __getitem__(self, i: int) -> 'IdEntityErrors':
                    return super().__getitem__(i)
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["Entities"]
    ) -> MetaOapg.properties.Entities:
        ...
    ...
    def __getitem__(self,
                    name: typing.Union[typing_extensions.Literal["Errors"],
                                       typing_extensions.Literal["Entities"],
