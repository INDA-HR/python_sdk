...
def lazy_import():
    ...
    globals()['IdEntityErrors'] = IdEntityErrors
    globals()['IdEntityMapping'] = IdEntityMapping


class MultiEntityMapping(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'entities': ([IdEntityMapping], ),  # noqa: E501
            'errors': ([IdEntityErrors], ),  # noqa: E501
            'total': (int, ),  # noqa: E501
            'hits': (int, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, entities, errors, *args,
                           **kwargs):  # noqa: E501
        """MultiEntityMapping - a model defined in OpenAPI

        Args:
            entities ([IdEntityMapping]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, entities, errors, *args, **kwargs):  # noqa: E501
        """MultiEntityMapping - a model defined in OpenAPI
