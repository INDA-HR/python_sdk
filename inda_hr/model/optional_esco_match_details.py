...
class OptionalEscoMatchDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            ([bool, date, datetime, dict, float, int, list, str,
              none_type], ),  # noqa: E501
            'preprocessed_esco_classification':
            ([bool, date, datetime, dict, float, int, list, str,
              none_type], ),  # noqa: E501
        }
    ...
    attribute_map = {
        'preprocessed_input': 'PreprocessedInput',  # noqa: E501
        'preprocessed_esco_classification':
        'PreprocessedESCOClassification',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OptionalEscoMatchDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            preprocessed_input ([bool, date, datetime, dict, float, int, list, str, none_type]): This field shows the preprocessed tokens of the input given by the user.. [optional]  # noqa: E501
            preprocessed_esco_classification ([bool, date, datetime, dict, float, int, list, str, none_type]): This field shows the preprocessed tokens of the most similar ESCO classification.. [optional]  # noqa: E501
        """
