...
def lazy_import():
    ...
    globals()['MatchingResumeDocument'] = MatchingResumeDocument
    globals()['QueryFilters'] = QueryFilters


class JobadMatchingQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'resume': (MatchingResumeDocument, ),  # noqa: E501
    ...
    def _from_openapi_data(cls, resume, *args, **kwargs):  # noqa: E501
        """JobadMatchingQuery - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resume, *args, **kwargs):  # noqa: E501
        """JobadMatchingQuery - a model defined in OpenAPI
