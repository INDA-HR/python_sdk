...
class EvidenceRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, query_terms, resume_ids, *args,
                           **kwargs):  # noqa: E501
        """EvidenceRequest - a model defined in OpenAPI

        Args:
            query_terms ([WeightedQueryTerm]):
            resume_ids ([str]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_terms, resume_ids, *args, **kwargs):  # noqa: E501
        """EvidenceRequest - a model defined in OpenAPI
