...
class SearchEvidence(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Terms"], typing_extensions.Literal["ID"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Terms"], typing_extensions.Literal["ID"], ]):
