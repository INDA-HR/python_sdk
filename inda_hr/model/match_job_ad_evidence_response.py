...
def lazy_import():
    ...
    globals()['MatchJobAdEvidenceElement'] = MatchJobAdEvidenceElement


class MatchJobAdEvidenceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'out': ([MatchJobAdEvidenceElement], ),  # noqa: E501
            'hits': (int, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, out, *args, **kwargs):  # noqa: E501
        """MatchJobAdEvidenceResponse - a model defined in OpenAPI

        Args:
            out ([MatchJobAdEvidenceElement]):
