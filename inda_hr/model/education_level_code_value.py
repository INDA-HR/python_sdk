...
class EducationLevelCodeValue(schemas.DictSchema):
    ...
    def __getitem__(
            self,
            name: typing_extensions.Literal["EQF"]) -> MetaOapg.properties.EQF:
        ...

    def __getitem__(self,
                    name: typing.Union[typing_extensions.Literal["EQF"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)

    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["EQF"]
    ) -> typing.Union[MetaOapg.properties.EQF, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        EQF: typing.Union[MetaOapg.properties.EQF, decimal.Decimal, int,
