...
class OptionalEntityBaseDetails(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["IsValidated"], typing_extensions.Literal["EntityType"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["IsValidated"], typing_extensions.Literal["EntityType"], ]):
