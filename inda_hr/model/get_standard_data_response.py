...
class GetStandardDataResponse(schemas.DictSchema):
        ...
        class properties:
            ...
            class Data(schemas.ListSchema):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['StandardDataItem']:
                        return StandardDataItem

                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StandardDataItem'],
                                       typing.List['StandardDataItem']],
                ...
                def __getitem__(self, i: int) -> 'StandardDataItem':
