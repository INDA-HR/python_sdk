...
def lazy_import():
    ...
    globals()['DocsBucketItem'] = DocsBucketItem


class DocsImportItemRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'files': ([DocsBucketItem], ),  # noqa: E501
            'credentials': (AwsCredentials, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, bucket, files, *args, **kwargs):  # noqa: E501
        """DocsImportItemRequest - a model defined in OpenAPI

        Args:
            bucket (str):
            files ([DocsBucketItem]):
        ...
        Keyword Args:
            ...
            credentials (AwsCredentials): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, bucket, files, *args, **kwargs):  # noqa: E501
        """DocsImportItemRequest - a model defined in OpenAPI
