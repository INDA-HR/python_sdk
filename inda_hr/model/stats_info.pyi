...
class StatsInfo(
    ...
    DocType: MetaOapg.properties.DocType
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Count"], typing_extensions.Literal["DocType"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DocType"]) -> MetaOapg.properties.DocType: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Count"], typing_extensions.Literal["DocType"], ]):
