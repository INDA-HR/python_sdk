...
class Industries(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Industry"], typing_extensions.Literal["Frequency"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Industry"], typing_extensions.Literal["Frequency"], ]):
