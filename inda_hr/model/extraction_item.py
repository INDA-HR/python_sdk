...
def lazy_import():
    ...
    globals(
    )['ExtractionResponsesAttachments'] = ExtractionResponsesAttachments
    globals()['ResumeCommonData'] = ResumeCommonData


class ExtractionItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'attachments': (ExtractionResponsesAttachments, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, attachments, *args,
                           **kwargs):  # noqa: E501
        """ExtractionItem - a model defined in OpenAPI

        Args:
            data (ResumeCommonData):
            attachments (ExtractionResponsesAttachments):
