...
class FoundCandidatesResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Out(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SearchCandidateElement'], typing.List['SearchCandidateElement']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Out"], typing_extensions.Literal["Total"], typing_extensions.Literal["Hits"], typing_extensions.Literal["SearchID"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Out"], typing_extensions.Literal["Total"], typing_extensions.Literal["Hits"], typing_extensions.Literal["SearchID"], ]):
