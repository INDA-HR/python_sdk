...
def lazy_import():
    ...
    globals()['PreferredEducation'] = PreferredEducation
    globals()['RequiredEducation'] = RequiredEducation


class MatchingEducation(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'preferred': (PreferredEducation, ),  # noqa: E501
            'required': (RequiredEducation, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, preferred, required, *args,
                           **kwargs):  # noqa: E501
        """MatchingEducation - a model defined in OpenAPI

        Args:
            preferred (PreferredEducation):
    ...
    @convert_js_args_to_python_args
    def __init__(self, preferred, required, *args, **kwargs):  # noqa: E501
        """MatchingEducation - a model defined in OpenAPI
