...
def lazy_import():
    ...
    globals()['KeywordsOut'] = KeywordsOut
...
class KeywordsResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, errors, out, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, errors, out, *args, **kwargs):  # noqa: E501
        """KeywordsResponse - a model defined in OpenAPI
