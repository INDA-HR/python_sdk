...
class SearchCandidateElement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Rank"], typing_extensions.Literal["ID"], typing_extensions.Literal["Data"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Rank"], typing_extensions.Literal["ID"], typing_extensions.Literal["Data"], ]):
