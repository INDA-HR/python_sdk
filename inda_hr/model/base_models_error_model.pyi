...
class BaseModelsErrorModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["detail"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["detail"], ]):
