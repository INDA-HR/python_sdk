...
class GetExtendedStandardDataResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ExtendedStandardDataItem], ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """GetExtendedStandardDataResponse - a model defined in OpenAPI

        Args:
            data ([ExtendedStandardDataItem]):
