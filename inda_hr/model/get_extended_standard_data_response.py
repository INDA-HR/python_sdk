...
class GetExtendedStandardDataResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Data(schemas.ListSchema):

                class MetaOapg:

                    @staticmethod
                    def items() -> typing.Type['ExtendedStandardDataItem']:
                        return ExtendedStandardDataItem

                def __new__(
                    cls,
                    _arg: typing.Union[
                        typing.Tuple['ExtendedStandardDataItem'],
                        typing.List['ExtendedStandardDataItem']],
                ...
                def __getitem__(self, i: int) -> 'ExtendedStandardDataItem':
