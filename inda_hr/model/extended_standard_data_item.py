...
class ExtendedStandardDataItem(ModelNormal):
    ...
    def _from_openapi_data(cls, code, value, language, label, *args,
                           **kwargs):  # noqa: E501
        """ExtendedStandardDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, value, language, label, *args,
                 **kwargs):  # noqa: E501
        """ExtendedStandardDataItem - a model defined in OpenAPI
