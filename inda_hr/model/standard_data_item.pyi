...
class StandardDataItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Code", "Value", "Language", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Code", "Value", "Language", ], str]):
