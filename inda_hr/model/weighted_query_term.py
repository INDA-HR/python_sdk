...
class WeightedQueryTerm(ModelNormal):
    ...
    def _from_openapi_data(cls, term, *args, **kwargs):  # noqa: E501
        """WeightedQueryTerm - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            language (str): The language this term is expressed in.. [optional]  # noqa: E501
            weight (float): Optional. Must be between <code style='color: #333333; opacity: 0.9'>0</code> (excluded) and <code style='color: #333333; opacity: 0.9'>1</code>.. [optional] if omitted the server will use the default value of 1.0  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, term, *args, **kwargs):  # noqa: E501
        """WeightedQueryTerm - a model defined in OpenAPI
