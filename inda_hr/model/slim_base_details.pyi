...
class SlimBaseDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["IsValidated"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["IsValidated"], ]):
