...
def lazy_import():
    ...
    globals()['RelatedTerms'] = RelatedTerms


class MatchEvidenceTerm(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'term': (str, ),  # noqa: E501
            'details': (RelatedTerms, ),  # noqa: E501
    ...
    def _from_openapi_data(cls, score, term, *args, **kwargs):  # noqa: E501
        """MatchEvidenceTerm - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            details (RelatedTerms): [optional]  # noqa: E501
            weight (float): How much the field influenced the final score.. [optional] if omitted the server will use the default value of 1  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, score, term, *args, **kwargs):  # noqa: E501
        """MatchEvidenceTerm - a model defined in OpenAPI
