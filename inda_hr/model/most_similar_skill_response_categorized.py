...
class MostSimilarSkillResponseCategorized(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'skill': (EscoCommonSkill, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, skill, *args, **kwargs):  # noqa: E501
        """MostSimilarSkillResponseCategorized - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, skill, *args, **kwargs):  # noqa: E501
        """MostSimilarSkillResponseCategorized - a model defined in OpenAPI
