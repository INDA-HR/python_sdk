...
class LoginData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Email"], typing_extensions.Literal["Tenant"], typing_extensions.Literal["Password"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Email"], typing_extensions.Literal["Tenant"], typing_extensions.Literal["Password"], ]):
