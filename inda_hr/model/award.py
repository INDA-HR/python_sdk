...
class Award(schemas.DictSchema):
    ...
    def __getitem__(
            self,
            name: typing_extensions.Literal["Awarder"]) -> 'Organization':
        ...
    ...
    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["Title"],
                                 ...
                                 typing_extensions.Literal["Awarder"], ]):
    ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["Year"]
    ) -> typing.Union['Date', schemas.Unset]:
        ...

    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["Awarder"]
