...
def lazy_import():
    ...
    globals()['MostRecentItem'] = MostRecentItem


class MostRecentResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, indexname, hits, total, out, *args,
                           **kwargs):  # noqa: E501
        """MostRecentResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, indexname, hits, total, out, *args,
                 **kwargs):  # noqa: E501
        """MostRecentResponse - a model defined in OpenAPI
