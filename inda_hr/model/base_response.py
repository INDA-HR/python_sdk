...
class BaseResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Prices(schemas.DictSchema):
                ...
                def __new__(
                    ...
                    **kwargs: typing.Union[MetaOapg.additional_properties,
            ...
            class Detail(schemas.ListSchema):

                class MetaOapg:

                    @staticmethod
                    def items() -> typing.Type['HistoryDetail']:
                        return HistoryDetail

                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['HistoryDetail'],
                                       typing.List['HistoryDetail']],
                    _configuration: typing.Optional[
                        schemas.Configuration] = None,
                ) -> 'Detail':
                    return super().__new__(
                ...
                def __getitem__(self, i: int) -> 'HistoryDetail':
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["Prices"]
    ) -> MetaOapg.properties.Prices:
        ...
    ...
    def __getitem__(self,
                    name: typing.Union[typing_extensions.Literal["Count"],
                                       typing_extensions.Literal["Prices"],
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["Prices"]
    ) -> typing.Union[MetaOapg.properties.Prices, schemas.Unset]:
        ...
    ...
    def get_item_oapg(
        self, name: typing.Union[typing_extensions.Literal["Count"],
                                 typing_extensions.Literal["Prices"],
                                 typing_extensions.Literal["Detail"], ]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Prices: typing.Union[MetaOapg.properties.Prices, dict,
