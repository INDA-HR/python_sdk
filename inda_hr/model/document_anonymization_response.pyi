...
class DocumentAnonymizationResponse(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FileExt"], typing_extensions.Literal["File"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FileExt"], typing_extensions.Literal["File"], ]):
