...
class DateBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Begin"], typing_extensions.Literal["End"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Begin"], typing_extensions.Literal["End"], ]):
