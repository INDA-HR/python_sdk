...
class SearchJobAdElement(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Data() -> typing.Type['JobadCommonMinimalData']:
                return JobadCommonMinimalData
            __annotations__ = {
                "Score": Score,
                "Rank": Rank,
                "ID": ID,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Data"]) -> 'JobadCommonMinimalData': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Data"], typing_extensions.Literal["Rank"], typing_extensions.Literal["ID"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Data"]) -> 'JobadCommonMinimalData': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Data"], typing_extensions.Literal["Rank"], typing_extensions.Literal["ID"], ]):
