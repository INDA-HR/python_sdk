...
class UniversityAutocomplete(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AltName"]) -> MetaOapg.properties.AltName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Acronym"]) -> MetaOapg.properties.Acronym: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ID"], typing_extensions.Literal["Name"], typing_extensions.Literal["AltName"], typing_extensions.Literal["Acronym"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AltName"]) -> typing.Union[MetaOapg.properties.AltName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Acronym"]) -> typing.Union[MetaOapg.properties.Acronym, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ID"], typing_extensions.Literal["Name"], typing_extensions.Literal["AltName"], typing_extensions.Literal["Acronym"], ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        AltName: typing.Union[MetaOapg.properties.AltName, str, schemas.Unset] = schemas.unset,
