...
class ResumeJobTitleDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["IsValidated"], typing_extensions.Literal["EntityType"], typing_extensions.Literal["Code"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["IsValidated"], typing_extensions.Literal["EntityType"], typing_extensions.Literal["Code"], ]):
