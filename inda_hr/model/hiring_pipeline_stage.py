...
class HiringPipelineStage(ModelNormal):
    ...
    def _from_openapi_data(cls, date, status, *args, **kwargs):  # noqa: E501
        """HiringPipelineStage - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): A brief description indicating the reason why the state has changed. E.g.: the status 'DISQUALIFIED' could be used both to exclude candidates which are unsuitable or those who refused the job offer.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, status, *args, **kwargs):  # noqa: E501
        """HiringPipelineStage - a model defined in OpenAPI
