...
class ExtendedStandardDataItem(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Code", "Value", "Language", "Label", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Code", "Value", "Language", "Label", ], str]):
