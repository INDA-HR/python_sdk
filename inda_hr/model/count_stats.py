...
class CountStats(ModelNormal):
    ...
    def _from_openapi_data(cls, sent, queued, *args, **kwargs):  # noqa: E501
        """CountStats - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, sent, queued, *args, **kwargs):  # noqa: E501
        """CountStats - a model defined in OpenAPI
