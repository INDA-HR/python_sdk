...
class MatchResumeEvidenceSkill(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Skill() -> typing.Type['ResumeSkill']:
                return ResumeSkill
            __annotations__ = {
                "Score": Score,
                "Skill": Skill,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Skill"]) -> 'ResumeSkill': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Skill"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Skill"]) -> 'ResumeSkill': ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Skill"], ]):
