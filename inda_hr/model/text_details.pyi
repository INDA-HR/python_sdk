...
class TextDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], ]):
