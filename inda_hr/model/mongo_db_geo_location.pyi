...
class MongoDBGeoLocation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Lon"], typing_extensions.Literal["Lat"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Lon"], typing_extensions.Literal["Lat"], ]):
