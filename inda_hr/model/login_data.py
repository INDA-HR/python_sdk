...
class LoginData(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["Tenant"]
    ) -> MetaOapg.properties.Tenant:
        ...
    ...
    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["Email"],
                                 typing_extensions.Literal["Tenant"],
