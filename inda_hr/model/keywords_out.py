...
class KeywordsOut(ModelNormal):
    ...
    def _from_openapi_data(cls, query, language, results, *args,
                           **kwargs):  # noqa: E501
        """KeywordsOut - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, query, language, results, *args,
                 **kwargs):  # noqa: E501
        """KeywordsOut - a model defined in OpenAPI
