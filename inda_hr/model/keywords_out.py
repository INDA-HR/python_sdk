...
class KeywordsOut(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Results(schemas.ListSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["Results"]
    ) -> MetaOapg.properties.Results:
        ...

    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["Language"],
                                 typing_extensions.Literal["Query"],
                                 typing_extensions.Literal["Results"], ]):
