...
def lazy_import():
    ...
    globals()['StatsInfo'] = StatsInfo


class StatsIndex(ModelNormal):
    ...
    def _from_openapi_data(cls, indexname, stats, *args,
                           **kwargs):  # noqa: E501
        """StatsIndex - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, indexname, stats, *args, **kwargs):  # noqa: E501
        """StatsIndex - a model defined in OpenAPI
