...
class RequiredAndPreferredConstrainedListValue(ModelNormal):
    ...
    def _from_openapi_data(cls, required, preferred, *args,
                           **kwargs):  # noqa: E501
        """RequiredAndPreferredConstrainedListValue - a model defined in OpenAPI

        Args:
            required ([OptionalJobAdSkill]):
            preferred ([OptionalJobAdSkill]):
