...
class OptionalSlimJobAdLanguageDetails(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["Code"], typing_extensions.Literal["Category"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["Code"], typing_extensions.Literal["Category"], ]):
