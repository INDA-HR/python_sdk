...
def lazy_import():
    ...
    globals()['DocsImportResume'] = DocsImportResume
    globals()['Internalid'] = Internalid


class DocsBucketItem(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'resume': (DocsImportResume, ),  # noqa: E501
            'url': (str, ),  # noqa: E501
    ...
    def _from_openapi_data(cls, resume, url, internal_id, *args,
                           **kwargs):  # noqa: E501
        """DocsBucketItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resume, url, internal_id, *args,
                 **kwargs):  # noqa: E501
        """DocsBucketItem - a model defined in OpenAPI
