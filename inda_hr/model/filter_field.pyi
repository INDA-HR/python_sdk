...
class FilterField(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Field"], typing_extensions.Literal["Type"], typing_extensions.Literal["Value"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Field"], typing_extensions.Literal["Type"], typing_extensions.Literal["Value"], ]):
