...
class GetApplicationsResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Applications"], typing_extensions.Literal["ResumeID"], typing_extensions.Literal["Total"], typing_extensions.Literal["Hits"], typing_extensions.Literal["SearchID"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Applications"], typing_extensions.Literal["ResumeID"], typing_extensions.Literal["Total"], typing_extensions.Literal["Hits"], typing_extensions.Literal["SearchID"], ]):
