...
class CacheDeletion(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["SearchID"], typing_extensions.Literal["Deleted"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["SearchID"], typing_extensions.Literal["Deleted"], ]):
