...
class MostSimilarJobtitleResponseCategorized(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Jobtitle() -> typing.Type['Jobtitle']:
                return Jobtitle
            __annotations__ = {
                "Jobtitle": Jobtitle,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Jobtitle"]) -> 'Jobtitle': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Jobtitle"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Jobtitle"]) -> 'Jobtitle': ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Jobtitle"], ]):
