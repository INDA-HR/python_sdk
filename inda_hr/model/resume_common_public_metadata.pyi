...
class ResumeCommonPublicMetadata(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["LastModified"], typing_extensions.Literal["CreationDate"], typing_extensions.Literal["Language"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["LastModified"], typing_extensions.Literal["CreationDate"], typing_extensions.Literal["Language"], ]):
