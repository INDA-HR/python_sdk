...
class MatchJobAdEvidenceSkill(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Skill() -> typing.Type['JobAdSkill']:
                return JobAdSkill
            __annotations__ = {
                "Score": Score,
                "Skill": Skill,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Skill"]) -> 'JobAdSkill': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Skill"]) -> 'JobAdSkill': ...
