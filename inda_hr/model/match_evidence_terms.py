...
def lazy_import():
    ...
    globals()['MatchEvidenceTerm'] = MatchEvidenceTerm


class MatchEvidenceTerms(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'terms': ([MatchEvidenceTerm], ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, score, terms, *args, **kwargs):  # noqa: E501
        """MatchEvidenceTerms - a model defined in OpenAPI

        Args:
            score (float): Normalized score. Min Score is 0 and Max Score is 1.
            terms ([MatchEvidenceTerm]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, score, terms, *args, **kwargs):  # noqa: E501
        """MatchEvidenceTerms - a model defined in OpenAPI
