...
def lazy_import():
    ...
    globals()['UniversityData'] = UniversityData
    globals()['UniversityPublicMetadata'] = UniversityPublicMetadata


class GetUniversityResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (UniversityData, ),  # noqa: E501
            'id': (str, ),  # noqa: E501
            'metadata': (UniversityPublicMetadata, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, id, metadata, *args,
                           **kwargs):  # noqa: E501
        """GetUniversityResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, data, id, metadata, *args, **kwargs):  # noqa: E501
        """GetUniversityResponse - a model defined in OpenAPI
