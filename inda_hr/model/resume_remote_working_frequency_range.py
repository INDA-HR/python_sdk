...
class ResumeRemoteWorkingFrequencyRange(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'range': (RangeModelFloat, ),  # noqa: E501
    ...
    def _from_openapi_data(cls, range, *args, **kwargs):  # noqa: E501
        """ResumeRemoteWorkingFrequencyRange - a model defined in OpenAPI

        Args:
            range (RangeModelFloat):
