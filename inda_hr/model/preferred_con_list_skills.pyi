...
class PreferredConListSkills(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Preferred"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Preferred"], ]):
