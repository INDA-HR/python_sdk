...
class ProficiencyLevelCode(schemas.DictSchema):
    ...
    def __getitem__(self,
                    name: typing_extensions.Literal["CEFR"]) -> 'CEFRLevels':
        ...

    def __getitem__(self,
                    name: typing.Union[typing_extensions.Literal["CEFR"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)

    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["CEFR"]
    ) -> typing.Union['CEFRLevels', schemas.Unset]:
        ...
