...
class MultiEntityInput(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Entities(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['IdEntityInput'], typing.List['IdEntityInput']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Entities"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Entities"], ]):
