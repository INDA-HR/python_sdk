...
def lazy_import():
    ...
    globals()['SemanticCommonSimpleTerm'] = SemanticCommonSimpleTerm


class TraditionalDocsSearchQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'query_terms': ([SemanticCommonSimpleTerm], ),  # noqa: E501
    ...
    def _from_openapi_data(cls, query_terms, *args, **kwargs):  # noqa: E501
        """TraditionalDocsSearchQuery - a model defined in OpenAPI

        Args:
            query_terms ([SemanticCommonSimpleTerm]): List of terms to search in documents
