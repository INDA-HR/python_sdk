...
class SemanticFeedbackRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'terms': ([WeightedQueryTerm], ),  # noqa: E501
            'rank': (int, ),  # noqa: E501
            'feedback': (int, ),  # noqa: E501
            'evidence': ([SearchTerm], ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, terms, rank, feedback, *args,
                           **kwargs):  # noqa: E501
        """SemanticFeedbackRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            evidence ([SearchTerm]): Optional. *Terms* field from the [Search Resumes Evidence](https://api.inda.ai/hr/docs/v2/#operation/search_resumes_evidence__POST) response.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, terms, rank, feedback, *args, **kwargs):  # noqa: E501
        """SemanticFeedbackRequest - a model defined in OpenAPI
