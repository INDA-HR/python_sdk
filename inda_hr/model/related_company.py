...
class RelatedCompany(schemas.DictSchema):
    ...
    def __getitem__(self,
                    name: typing_extensions.Literal["Relation"]) -> 'Relation':
        ...

    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["CompanyID"]
    ) -> MetaOapg.properties.CompanyID:
        ...

    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["Relation"],
                                 typing_extensions.Literal["CompanyID"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)

    @typing.overload
    def get_item_oapg(
            self, name: typing_extensions.Literal["Relation"]) -> 'Relation':
        ...
