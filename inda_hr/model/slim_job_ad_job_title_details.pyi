...
class SlimJobAdJobTitleDetails(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Code"]) -> 'JobAdJobTitleCode': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Category"]) -> MetaOapg.properties.Category: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Weight"], typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["Code"], typing_extensions.Literal["Category"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Code"]) -> typing.Union['JobAdJobTitleCode', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Category"]) -> typing.Union[MetaOapg.properties.Category, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Weight"], typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["Code"], typing_extensions.Literal["Category"], ]):
