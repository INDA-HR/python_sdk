...
class MatchJobAdEvidenceJobTitle(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def JobTitle() -> typing.Type['JobAdJobTitle']:
                return JobAdJobTitle
            __annotations__ = {
                "Score": Score,
                "JobTitle": JobTitle,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["JobTitle"]) -> 'JobAdJobTitle': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["JobTitle"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["JobTitle"]) -> 'JobAdJobTitle': ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["JobTitle"], ]):
