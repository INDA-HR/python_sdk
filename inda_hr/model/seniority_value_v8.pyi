...
class SeniorityValueV8(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Value"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Score"], typing_extensions.Literal["Value"], ]):
