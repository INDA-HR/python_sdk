...
class IdEntityInput(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["EntityID"]
    ) -> MetaOapg.properties.EntityID:
        ...

    @typing.overload
    def __getitem__(
            self, name: typing_extensions.Literal["Entity"]) -> 'EntityInput':
        ...

    def __getitem__(self,
                    name: typing.Union[typing_extensions.Literal["EntityID"],
                                       typing_extensions.Literal["Entity"], ]):
    ...
    def get_item_oapg(
        self, name: typing.Union[typing_extensions.Literal["EntityID"],
                                 typing_extensions.Literal["Entity"], ]):
