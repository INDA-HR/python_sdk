...
class DocsBucketItem(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Resume"]) -> 'DocsImportResume': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Resume"]) -> 'DocsImportResume': ...
