...
def lazy_import():
    ...
    globals()['HiringPipelineStage'] = HiringPipelineStage


class HiringDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hiring_date': (date, ),  # noqa: E501
            'hiring_pipeline': ([HiringPipelineStage], ),  # noqa: E501
        }
    ...
    attribute_map = {
        'application_date': 'ApplicationDate',  # noqa: E501
        'hiring_date': 'HiringDate',  # noqa: E501
        'hiring_pipeline': 'HiringPipeline',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, application_date, *args,
                           **kwargs):  # noqa: E501
        """HiringDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            hiring_date (date): The hiring date keeps track of the date in which the candidate has been hired. It is a replica of the hiring pipeline step corresponding to the status 'HIRED'. Format: 'YYYY-MM-DD'.. [optional]  # noqa: E501
            hiring_pipeline ([HiringPipelineStage]): The hiring pipeline is meant to register the candidate history through the hiring process, thus registering both forward and backward steps in any order.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_date, *args, **kwargs):  # noqa: E501
        """HiringDetails - a model defined in OpenAPI
