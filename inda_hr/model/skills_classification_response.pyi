...
class SkillsClassificationResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class Skills(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SkillsResponsesSkill'], typing.List['SkillsResponsesSkill']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Skills"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Skills"], ]):
