...
class ImportItemResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["InternalID"], typing_extensions.Literal["ResumeID"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["InternalID"], typing_extensions.Literal["ResumeID"], ]):
