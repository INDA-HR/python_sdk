...
class RangeModelLTEFloat(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["LTE"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["LTE"], ]):
