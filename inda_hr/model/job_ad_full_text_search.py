...
def lazy_import():
    ...
    globals()['JobadRequestsSimpleTerm'] = JobadRequestsSimpleTerm
    globals()['QueryFilters'] = QueryFilters


class JobAdFullTextSearch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'query_terms': ([JobadRequestsSimpleTerm], ),  # noqa: E501
    ...
    def _from_openapi_data(cls, query_terms, *args, **kwargs):  # noqa: E501
        """JobAdFullTextSearch - a model defined in OpenAPI

        Args:
            query_terms ([JobadRequestsSimpleTerm]): List of terms to search in documents.
