...
class ImageMetadata(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FileExt"], typing_extensions.Literal["Filename"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FileExt"], typing_extensions.Literal["Filename"], ]):
