...
class WeightedQueryTerm(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Term"], typing_extensions.Literal["Language"], typing_extensions.Literal["Weight"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Term"], typing_extensions.Literal["Language"], typing_extensions.Literal["Weight"], ]):
