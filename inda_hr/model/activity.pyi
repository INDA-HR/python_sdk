...
class Activity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Value"], typing_extensions.Literal["Tags"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Value"], typing_extensions.Literal["Tags"], ]):
