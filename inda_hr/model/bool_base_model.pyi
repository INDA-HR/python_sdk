...
class BoolBaseModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["IsPossible"], typing_extensions.Literal["IsMandatory"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["IsPossible"], typing_extensions.Literal["IsMandatory"], ]):
