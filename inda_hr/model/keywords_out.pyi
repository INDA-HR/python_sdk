...
class KeywordsOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Language"], typing_extensions.Literal["Query"], typing_extensions.Literal["Results"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Language"], typing_extensions.Literal["Query"], typing_extensions.Literal["Results"], ]):
