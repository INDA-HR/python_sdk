...
class OptionalResumeJobTitleDetails(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Code"]) -> 'ResumeJobTitleCode': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["IsValidated"], typing_extensions.Literal["EntityType"], typing_extensions.Literal["Score"], typing_extensions.Literal["Code"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Code"]) -> typing.Union['ResumeJobTitleCode', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TextPositions"], typing_extensions.Literal["RawValue"], typing_extensions.Literal["RawValues"], typing_extensions.Literal["IsValidated"], typing_extensions.Literal["EntityType"], typing_extensions.Literal["Score"], typing_extensions.Literal["Code"], ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Code: typing.Union['ResumeJobTitleCode', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
