...
class BroaderLevelSkill(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["URI"], typing_extensions.Literal["Label"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["URI"], typing_extensions.Literal["Label"], ]):
