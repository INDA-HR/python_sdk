...
class HistoryDetail(ModelNormal):
    ...
    def _from_openapi_data(cls, indexname, datetime, status_code, advanced,
                           price, api_call, *args, **kwargs):  # noqa: E501
        """HistoryDetail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, indexname, datetime, status_code, advanced, price,
                 api_call, *args, **kwargs):  # noqa: E501
        """HistoryDetail - a model defined in OpenAPI
