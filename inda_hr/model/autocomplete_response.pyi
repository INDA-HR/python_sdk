...
class AutocompleteResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Candidates"], typing_extensions.Literal["Term"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Candidates"]) -> MetaOapg.properties.Candidates: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Term"]) -> MetaOapg.properties.Term: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Candidates"], typing_extensions.Literal["Term"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        Candidates: typing.Union[MetaOapg.properties.Candidates, dict, frozendict.frozendict, ],
