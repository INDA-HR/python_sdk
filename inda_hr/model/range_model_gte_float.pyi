...
class RangeModelGTEFloat(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["GTE"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["GTE"], ]):
