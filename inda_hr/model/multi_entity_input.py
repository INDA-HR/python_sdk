...
class MultiEntityInput(schemas.DictSchema):
        ...
        class properties:
            ...
            class Entities(schemas.ListSchema):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IdEntityInput']:
                        return IdEntityInput

                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['IdEntityInput'],
                                       typing.List['IdEntityInput']],
                ...
                def __getitem__(self, i: int) -> 'IdEntityInput':
    ...
    def __getitem__(
            self, name: typing.Union[typing_extensions.Literal["Entities"], ]):
