...
def lazy_import():
    ...
    globals()['IdEntityInput'] = IdEntityInput


class MultiEntityInput(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'entities': ([IdEntityInput], ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, entities, *args, **kwargs):  # noqa: E501
        """MultiEntityInput - a model defined in OpenAPI

        Args:
            entities ([IdEntityInput]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, entities, *args, **kwargs):  # noqa: E501
        """MultiEntityInput - a model defined in OpenAPI
