...
class ValueModelMongoDBGeoLocation(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Value() -> typing.Type['MongoDBGeoLocation']:
                return MongoDBGeoLocation
    ...
    def __getitem__(
            self,
            name: typing_extensions.Literal["Value"]) -> 'MongoDBGeoLocation':
        ...
