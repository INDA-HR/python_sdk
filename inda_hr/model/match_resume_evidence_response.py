...
def lazy_import():
    ...
    globals()['MatchResumeEvidenceElement'] = MatchResumeEvidenceElement


class MatchResumeEvidenceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'out': ([MatchResumeEvidenceElement], ),  # noqa: E501
            'hits': (int, ),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, out, *args, **kwargs):  # noqa: E501
        """MatchResumeEvidenceResponse - a model defined in OpenAPI

        Args:
            out ([MatchResumeEvidenceElement]):
