...
class CustomField(ModelNormal):
    ...
    def _from_openapi_data(cls, field, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            params ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Field-dependent parameters used to configure its behaviour.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, field, type, *args, **kwargs):  # noqa: E501
        """CustomField - a model defined in OpenAPI
