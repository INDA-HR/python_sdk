...
class SuiteResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Credits"], typing_extensions.Literal["Name"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Credits"], typing_extensions.Literal["Name"], ]):
