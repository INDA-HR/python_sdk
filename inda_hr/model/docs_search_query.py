...
def lazy_import():
    ...
    globals()['QueryFilters'] = QueryFilters
    globals()['WeightedQueryTerm'] = WeightedQueryTerm


class DocsSearchQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'query_terms': ([WeightedQueryTerm], ),  # noqa: E501
            'query_filters': (QueryFilters, ),  # noqa: E501
        }
    ...
    attribute_map = {
        'query_terms': 'QueryTerms',  # noqa: E501
        'query_filters': 'QueryFilters',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, query_terms, *args, **kwargs):  # noqa: E501
        """DocsSearchQuery - a model defined in OpenAPI

        Args:
            query_terms ([WeightedQueryTerm]): List of terms with which the query is performed.Each term is composed by a *term*, its *language* and a *weight*representing the relevance the associated term should have.
        ...
        Keyword Args:
            ...
            query_filters (QueryFilters): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_terms, *args, **kwargs):  # noqa: E501
        """DocsSearchQuery - a model defined in OpenAPI
