...
class SuiteResponse(schemas.DictSchema):
    ...
    def __getitem__(self,
                    name: typing.Union[typing_extensions.Literal["Credits"],
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        Credits: typing.Union[MetaOapg.properties.Credits, decimal.Decimal,
                              int, float, ],
