...
class SuiteResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, name, credits, *args, **kwargs):  # noqa: E501
        """SuiteResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, credits, *args, **kwargs):  # noqa: E501
        """SuiteResponse - a model defined in OpenAPI
