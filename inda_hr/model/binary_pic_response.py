...
class BinaryPicResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, file_ext, file, id, *args,
                           **kwargs):  # noqa: E501
        """BinaryPicResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, file_ext, file, id, *args, **kwargs):  # noqa: E501
        """BinaryPicResponse - a model defined in OpenAPI
