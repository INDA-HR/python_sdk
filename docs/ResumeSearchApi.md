...
with inda_hr.ApiClient(configuration) as api_client:
    ...
    try:
        # Search Resumes Evidence
        api_response = api_instance.search_resumes_evidence_post(indexname, evidence_request, size=size)
        pprint(api_response)
    except inda_hr.ApiException as e:
        print("Exception when calling ResumeSearchApi->search_resumes_evidence_post: %s\n" % e)
```
...
with inda_hr.ApiClient(configuration) as api_client:
    ...
    try:
        # Search Resumes
        api_response = api_instance.search_resumes_post(indexname, cache=cache, cache_time=cache_time, size=size, offset=offset, min_score=min_score, search_id=search_id, docs_search_query=docs_search_query)
        pprint(api_response)
    except inda_hr.ApiException as e:
        print("Exception when calling ResumeSearchApi->search_resumes_post: %s\n" % e)
```
