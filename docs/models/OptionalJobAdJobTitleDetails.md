# inda_hr.model.optional_job_ad_job_title_details.OptionalJobAdJobTitleDetails
...
**Weight** | decimal.Decimal, int, float,  | decimal.Decimal,  |  Weight of the job title. Used for mathing purposes. | [optional] if omitted the server will use the default value of 0.75
