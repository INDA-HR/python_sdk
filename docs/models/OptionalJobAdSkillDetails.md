# inda_hr.model.optional_job_ad_skill_details.OptionalJobAdSkillDetails
...
**Weight** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] if omitted the server will use the default value of 0.75
