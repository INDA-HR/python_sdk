# inda_hr.model.optional_resume_job_title_details.OptionalResumeJobTitleDetails
...
**Score** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | [optional] if omitted the server will use the default value of 0.75
